export const activities = [
  { id: 'shape-home', title: '形状回家', en: 'LITTLE SHAPE HOMES', color: '#d78355', background: '#f4e8d9', icon: 'shapes', description: '圆形、方形、星星和爱心，9 种形状轮流找家。完成一关，再认识新朋友。', skill: '形状 · 配对', tip: '找一个圆盘子和一块方积木，和孩子一起摸摸它们的边。', intro: '帮积木找到自己的家', instruction: '先点积木，再点它的家；也可以拖过去。', done: '积木都回家啦！' },
  ...
  { id: 'color-sort', title: '颜色分一分', en: 'A BASKET OF COLORS', color: '#6d98bb', background: '#e5edf3', icon: 'basket', description: '红黄蓝绿，6 种颜色换着分。每关都有新的组合，送小球回同色篮子。', skill: '颜色 · 分类', tip: '收玩具时一起找相同的颜色，不用急着说出颜色的名字。', intro: '小球要去哪个篮子？', instruction: '点一个球，再点同色篮子；也可以拖过去。', done: '小球收拾好啦！' },
  { id: 'little-puzzle', title: '两块小拼图', en: 'PIECE BY LITTLE PIECE', color: '#b494ba', background: '#eee6ef', icon: 'car', description: '小汽车、小鸭和小熊，8 幅图片换着拼。从两块开始，一关一幅新发现。', skill: '观察 · 空间', tip: '一起指指车轮、车窗，再找一辆真的玩具车。', intro: '拼出一辆小汽车', instruction: '把图片放到对应位置，浅浅的底图会帮你。', done: '小汽车拼好啦！' },
...
export const toddlerGames = activities.map(activity => ({
  ...
  tags: ['2岁起亲子玩', '连续关卡', activity.skill],
